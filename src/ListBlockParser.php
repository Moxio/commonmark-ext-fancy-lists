...
{
    private FancyListData $listData;
    ...
    public function __construct(FancyListData $listData)
    {
        $this->listData = $listData;

        $listBlock = new ListBlock($listData);
        if ($listData->numberingType !== null) {
            $listBlock->data->set("attributes.type", $listData->numberingType);
        }
        if ($listData->hasOrdinalIndicator) {
            $listBlock->data->set("attributes.class", "ordinal");
        }
